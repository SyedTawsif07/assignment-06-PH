...
const StepSection = () => {
    return (
        <div>
            <div className='bg-[#F9FAFC] space-y-3 py-15'>
                ...
                {/* cards */}
                <ul className='grid grid-cols-3 gap-5 container mx-auto mt-10 mb-14'>
                    <li className="relative bg-white border border-gray-200 rounded-xl p-8 h-[285px] flex flex-col items-center text-center shadow-sm">
